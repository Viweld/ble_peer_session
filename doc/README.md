...
Supplementary guides for [ble_peer_session](../README.md).
...
**Internals** (message framing, wire format) live in the [main README §6](../README.md#6-internals-for-contributors) — only needed for custom clients or BLE debugging.
